...
alias bbqu="echo ; bauerbill -Qu | grep -Ev '(core|extra|community)' | grep -v ^$ ; echo" 
...
alias cowerd='cower -d -t /projects/builds/'
...
alias gitupdt='for i in /projects/git/* ; do cd "$i" ; echo -e "${bldylw}$PWD${txtrst}" ; git pull ; done'
alias gti='git'
alias gv='gvim'
alias gvs='gvim -S'
