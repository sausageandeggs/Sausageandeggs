...
alias ccc='sudo clyde -S'
alias ccs='sudo clyde -Ss'
alias ccw='sudo clyde -Sw'
alias ccu='sudo clyde -Su'
alias ccuu='sudo clyde -Syu'
alias cd~='cd ~'
alias cd-='cd -'
alias cd.='cd ..'
alias cd..='cd ../..'
...
alias ck4up='ck4up -v'
alias ckup=' cd /projects/builds/kernel26-ck && rm -rf {pkg,src} && makepkg -i --noconfirm && cd /projects/builds/nvidia-beta-all && makepkg -f && rm -rf {pkg,src}'
...
alias orph='sudo pacman-color -Qdt'
...
alias pfup=' cd /projects/builds/kernel26-pf && rm -rf {pkg,src} && makepkg -i --noconfirm && cd /projects/builds/nvidia-beta-all && makepkg -f && rm -rf {pkg,src}'
alias pgkb='pkgb'
...
alias ppo='sudo pacman-color -Qo'
alias ppp='sudo pacman-color -S'
alias ppq='sudo pacman-color -Qs'
alias ppr='sudo pacman-color -R'
alias pprr='sudo pacman-color -Rnsu'
alias pprrr='sudo pacman-color -Rnsc'
alias pps='sudo pacman-color -Ss'
alias ppu='sudo pacman-color -U'
alias ppud='sudo pacman-color -U --asdeps'
alias ppw='sudo powerpill'
